...
public:  v8::MaybeLocal<v8::Value> __NAME__(std::initializer_list<v8::Local<v8::Value>> args = {});

#define JS_METHOD_IMPL(__NAME__) v8::MaybeLocal<v8::Value> __NAME__(std::initializer_list<v8::Local<v8::Value>> args) { return __NAME__##_.Get(env_.isolate())->CallAsFunction(env_.context(), value_.Get(env_.isolate()), args.size(), const_cast<v8::Local<v8::Value>*>(args.begin())); }
